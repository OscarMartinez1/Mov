 ...
 * TODO: NOMBRE DEL ALUMNO: "ESCRIBE AQUI TU NOMBRE"
 */
class PerfilActivity : AppCompatActivity() {
    ...
    private fun obtenerDatosdelIntent(){
        ...
        var Ape = intent.getStringExtra("Apellido")
        var Corr = intent.getStringExtra("Correo")
        var Cont = intent.getStringExtra("Contraseña")

        txvNombre.text=Nom
        txvApellido.text=Ape
        txvCorreo.text=Corr
